...
var $author$project$GMachine$EmptyStack = {$: 'EmptyStack'};
						...
						switch (_v0.b.a.$) {
							...
							case 'GFunc':
								...
								if (enoughArguments) {
									...
									if (_v8.$ === 'Just') {
										var redexRoot = _v8.a;
										return A2($author$project$GMachine$return, redexRoot, gmachine);
									} else {
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedCompile":[],"ChangedSourceCode":["String.String"],"ClickedStep":[],"WindowResized":["Basics.Int","Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));